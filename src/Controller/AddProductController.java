 ...
 * @version 1.0
 * /
/**controller class for the add products*/
public class AddProductController implements Initializable {
    ...
    /**cancel button handler on the add products screen. Closes the window and returns to the main screen*/
    @FXML
    ...
    /** remove button handler.  When clicked, will remove the selected part object in the modifyProductsAssociatedPartTable and add the selected product to the modifyProductPartsList */
    @FXML
    ...
    /**save button handler on the add product screen.
     * Uses data validation to detect correct entries into fields and,
     * if correct, will update a product object in the allproducts array
     * in the inventory class based on the modifyProductFieldIndex variable.*/
    @FXML
    ...
    /**Search method for use with the modifyProductFieldSearch.
     * Will iterate through the modifyProductPartsList using an int to match the id and return a Part if one is found

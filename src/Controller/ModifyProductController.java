...
/**controller class for the modify product page*/
public class ModifyProductController implements Initializable {
     ...
     * Populates the Parts and Associated parts tables from the AllParts array in the parts class and
     * the local AddProductAssociatedPartsList array*/
    @Override
    ...
    /**Handler to modify products Parts table Search bar.
     * It will search through the AllParts table either via an int or a String and return the search results or provide an error*/
    @FXML
     ...
     * When clicked, will add the selected part object in the modifyproductsparttable
     * to the modifyProductAssociatedPartsList array and remove the selected product from the modifyProductPartsList */
    ...
    /**controls the cancel button on modify products. Closes the current window and returns to the mainscreen page*/
    @FXML
     ...
     * When clicked, will remove the selected part object in
     * the modifyProductsAssociatedPartTable and add the selected product to the modifyProductPartsList */
    @FXML
    ...
    /**Handler for the save button on the modifyParts page.
     * Uses data validation to detect correct entries into fields and, if correct,
     * will attempt to update a product object in the allproducts array in the
     * inventory class based on the modifyProductFieldIndex variable.*/
    @FXML

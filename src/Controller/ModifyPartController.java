...
/**controller class to modify parts */
public class ModifyPartController {
    ...
    /**controls the cancel button on the modifyParts page. Closes the current window and returns to the mainscreen page*/
    @FXML
    ...
    /**controls the save button on the modifyParts page.
     * Uses data validation to detect correct entries into fields and,
     * if correct, will attempt to update a Part object in the allparts
     * array in the inventory class based on the modifyPartFieldIndex variable.*/
    @FXML
    void modifyPartBtnSave(ActionEvent event) throws Exception{
        ...
        try {
            ...
            else  if ((modifyPartRadioInHouse.isSelected() && !modifyPartFieldMachineID.getText().matches("[0-9]+")))
            {
    ...
    /**pulls data from the selected object in the MainScreenController page.
     * @param part Part object transferred from the MainScreenController page from the selection on the Parts Table
